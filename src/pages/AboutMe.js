    ...
    <div id='AboutMe' className='flex-container'>
      <div className='flex-child first'>
        ...
        <p className='description'> I am a 23yo girl who likes to learn new thing and develop new skills.
         Its been two years now that im working on Analytics (PowerBI and SQL more specifically) and i love it. Playing with the data until you get the result you want has been one of the things that has kept me stuck with what I'm working on.
